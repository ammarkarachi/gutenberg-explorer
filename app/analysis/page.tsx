...
export default function AnalysisPage() {
  ...
  const { getSavedAnalyses } = useBookCacheStore();
  useEffect(() => {
    ...
    <div className="space-y-6">
      <div className="text-center max-w-2xl mx-auto py-8">
        ...
        <p className="text-gray-600">
          View your saved analyses and gain deeper insights into your favorite
          books.
        </p>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          <p className="mb-4 text-gray-600">
            Select a book to analyze with AI or view your existing analyses
            below.
          </p>
                      ...
                      <div>
                        ...
                        <div className="flex items-center mt-2">
                          ...
                          <span className="text-xs text-gray-500 ml-2 flex items-center">
                            ...
                            {formatDistanceToNow(analysis.date, {
                              addSuffix: true,
                            })}
                          </span>
                        </div>
